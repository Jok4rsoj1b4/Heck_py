...
#CREATE BY : JOKAR SOJIB

#WHATSAPP : +8801609859866

#GITHUB : https://github.com/Jok4rsoj1b4
...
[] TYPE            : FREE enjoy/Tha tools

[] FACEBOOK  : JO'KA'R-SO'JIB
...
def fuck():
    ...
    print(' [+] OK Ids saved in SOJIB/OK.txt')

    print(' [+] CP Ids saved in SOJIB/CP.txt')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[SOJIB]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[1;92m[SOJIB-OK] {uid}|{ps} \nCookie : {coki}")

                os.system('espeak -a 300 " Ok,  Sojib#FFCE00#E70D00,  id"')
                ...
                #print(f"\033[1;94m[SOJIB-CP] {cid}|{ps}")
